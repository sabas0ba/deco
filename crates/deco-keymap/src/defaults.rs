...
pub const DEFAULT_KEYBINDINGS_JSONC: &str = r#"[
    ...
    { "key": "tab", "command": "jumpToNextSnippetPlaceholder", "when": "editorTextFocus && inSnippetMode && !editorReadonly" },
    { "key": "shift+tab", "command": "jumpToPrevSnippetPlaceholder", "when": "editorTextFocus && inSnippetMode && !editorReadonly" },
